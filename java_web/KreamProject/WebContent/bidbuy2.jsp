...
<script>
	$(function() {
		...
		$finalbtn.click(function(){
			 $section.load('./bidbuyend', function (responseTxt, statucTxt, xhr) {
	              if (statucTxt == "error")
...
<section class="rightcontent2">
    ...
    <div class="price_back">
      <div class="price_content">
        ...
        <div class="totalamount"><span>총 결제금액</span><span class="totalprice" >${customprice}원</span>
        </div>
        <br>
        <div class="hrline"></div>
        <br>
        <div class="price_info">
          <div class="free"><span class="title1">구매 희망가</span><span class="totalpriceB">${customprice}원</span></div>
    ...
    <div class="checkbox_back">
      ...
      <div class="checkbox_item">
        <div><p class="c_line1">구매 입찰의 거래가 체결되면, 단순 변심이나 실수에 의한 취소가 불가능합니다.</p>
    ...
    <div class="finalize">
      <input class="finalbtn" type="button" name="checkButton" value=" 구매 입찰하기 ">
    </div>
    <!-- <div class="blank"></div> -->
  </section>
