 ...
 <script>
 	$(function(){
		...
		$finalbtn.click(function(){
			 $section.load('./immedisellend', function (responseTxt, statucTxt, xhr) {
	              if (statucTxt == "error")
 ...
 <section class="rightcontent2">
    ...
    <div class="price_back">
      <div class="price_content">
        ...
        <div class="totalamount"><span>총 정산금액</span><span class="totalprice" >${maxprice}원</span>
        </div>
        <br>
        <div class="hrline"></div>
        <br>
        <div class="price_info">
          <div class="free"><span class="title1">즉시 판매가</span><span class="totalpriceB">${maxprice}원</span></div>
    ...
    <div class="checkbox_back">
      ...
      <div class="checkbox_item">
        <p class="c_line1">'바로 판매하기'를 선택하시면 즉시 거래가 체결되며, 단숨 변심이나 실수에 의한 취소가 불가능합니다.</p>
        <input class="checkboxbtn" type="checkbox" name="agree" id="a">
      </div>
      <div class="checkbox_item">
